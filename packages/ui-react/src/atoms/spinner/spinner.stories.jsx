...
stories.add('with size modifier', () => <Spinner size={selectSize(SIZE_LARGE)} />);

stories.add('with custom css-module class names', () => (
  <Spinner size={selectSize()} classNames={classNamesOverride} />
));

stories.add('with imported css-module class names', () => (
  <Spinner size={selectSize()} classNames={classNamesImport} />
));
